...
interface SbMbrProfileFakePanelProps {
  member: MemberStory;
}

export default function SbMbrProfileFakePanel({ member }: SbMbrProfileFakePanelProps) {
  ...
  return (
    <div className="bg-[#FDFCFB] border border-[#EFECE7] rounded-3xl p-6 shadow-[0_8px_20px_rgba(0,0,0,0.01)] flex flex-col gap-5 relative">
      ...
      <AdminComponentTag name="SbMbrProfileFakePanel" />
    </div>
  );
}
