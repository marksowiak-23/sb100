  ...
  const loadConfigs = useCallback(async () => {
    ...
    try {
      ...
      setConfigs([
        ...
        { configId: 'cfg-10', configTag: 'HOME_PAGE_GETTING_STARTED_CARD_ENABLED', configValue: 'true', configType: 'BOOLEAN', configGroup: 'UI', configDesc: 'Enable or disable processing and displaying the Getting Started card on the home page', configCreatedAt: new Date().toISOString(), configUpdatedAt: new Date().toISOString() },
        { configId: 'cfg-11', configTag: 'HOME_PAGE_PERSONAL_TRIVIA_CARD_ENABLED', configValue: 'true', configType: 'BOOLEAN', configGroup: 'UI', configDesc: 'Enable or disable processing and displaying the Personal Trivia card on the home page', configCreatedAt: new Date().toISOString(), configUpdatedAt: new Date().toISOString() },
        { configId: 'cfg-12', configTag: 'HOME_PAGE_REMEMBER_WHEN_CARD_ENABLED', configValue: 'true', configType: 'BOOLEAN', configGroup: 'UI', configDesc: 'Enable or disable processing and displaying the Remember When card on the home page', configCreatedAt: new Date().toISOString(), configUpdatedAt: new Date().toISOString() }
      ]);
    } finally {
      setLoading(false);
    }
