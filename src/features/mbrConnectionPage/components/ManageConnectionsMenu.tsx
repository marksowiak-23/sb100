...
export default function ManageConnectionsMenu({
  ...
  return (
    <div className="relative bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-5 shadow-xs overflow-hidden group">
      ...
      {/* Top Level Item: My Connections (Above Manage Header) */}
      <div className="pb-3 mb-2 border-b border-slate-100 dark:border-slate-800">
        <button
          type="button"
          onClick={() => onSelectSection('my-connections')}
      ...
      {/* Menu Header: Manage my Connections */}
      ...
      {/* Navigation Items List under Manage my Connections */}
